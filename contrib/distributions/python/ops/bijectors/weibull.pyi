# Stubs for tensorflow.contrib.distributions.python.ops.bijectors.weibull (Python 3)
#
...
class Weibull(bijector.Bijector):
    def __init__(self, scale: float = ..., concentration: float = ..., validate_args: bool = ..., name: str = ...) -> None: ...
    @property
    def scale(self): ...
    @property

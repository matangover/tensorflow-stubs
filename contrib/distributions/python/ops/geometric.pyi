# Stubs for tensorflow.contrib.distributions.python.ops.geometric (Python 3)
#
...
class Geometric(distribution.Distribution):
    def __init__(self, logits: Optional[Any] = ..., probs: Optional[Any] = ..., validate_args: bool = ..., allow_nan_stats: bool = ..., name: str = ...) -> None: ...
    @property
    def logits(self): ...
    @property
    def probs(self): ...

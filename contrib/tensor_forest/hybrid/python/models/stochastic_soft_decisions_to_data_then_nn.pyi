# Stubs for tensorflow.contrib.tensor_forest.hybrid.python.models.stochastic_soft_decisions_to_data_then_nn (Python 3)
#
...
class StochasticSoftDecisionsToDataThenNN(hard_decisions_to_data_then_nn.HardDecisionsToDataThenNN):
    layers: Any = ...

# Stubs for tensorflow.contrib.learn.python.learn.estimators.dnn (Python 3)
#
...
from tensorflow.contrib.layers.python.layers import feature_column as feature_column, optimizers as optimizers
from tensorflow.contrib.learn.python.learn import metric_spec as metric_spec
from tensorflow.contrib.learn.python.learn.estimators import dnn_linear_combined as dnn_linear_combined, estimator as estimator, model_fn as model_fn, prediction_key as prediction_key
from tensorflow.contrib.learn.python.learn.utils import export as export
from tensorflow.python.ops import nn as nn, partitioned_variables as partitioned_variables, variable_scope as variable_scope
...
class DNNClassifier(estimator.Estimator):
    def __init__(self, hidden_units: Any, feature_columns: Any, model_dir: Optional[Any] = ..., n_classes: int = ..., weight_column_name: Optional[Any] = ..., optimizer: Optional[Any] = ..., activation_fn: Any = ..., dropout: Optional[Any] = ..., gradient_clip_norm: Optional[Any] = ..., enable_centered_bias: bool = ..., config: Optional[Any] = ..., feature_engineering_fn: Optional[Any] = ..., embedding_lr_multipliers: Optional[Any] = ..., input_layer_min_slice_size: Optional[Any] = ..., label_keys: Optional[Any] = ...) -> None: ...
...
class DNNRegressor(estimator.Estimator):
    def __init__(self, hidden_units: Any, feature_columns: Any, model_dir: Optional[Any] = ..., weight_column_name: Optional[Any] = ..., optimizer: Optional[Any] = ..., activation_fn: Any = ..., dropout: Optional[Any] = ..., gradient_clip_norm: Optional[Any] = ..., enable_centered_bias: bool = ..., config: Optional[Any] = ..., feature_engineering_fn: Optional[Any] = ..., label_dimension: int = ..., embedding_lr_multipliers: Optional[Any] = ..., input_layer_min_slice_size: Optional[Any] = ...) -> None: ...
...
class DNNEstimator(estimator.Estimator):
    def __init__(self, head: Any, hidden_units: Any, feature_columns: Any, model_dir: Optional[Any] = ..., optimizer: Optional[Any] = ..., activation_fn: Any = ..., dropout: Optional[Any] = ..., gradient_clip_norm: Optional[Any] = ..., config: Optional[Any] = ..., feature_engineering_fn: Optional[Any] = ..., embedding_lr_multipliers: Optional[Any] = ..., input_layer_min_slice_size: Optional[Any] = ...) -> None: ...

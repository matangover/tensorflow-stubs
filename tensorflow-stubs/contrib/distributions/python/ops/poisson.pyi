# Stubs for tensorflow.contrib.distributions.python.ops.poisson (Python 3)
#
...
class Poisson(distribution.Distribution):
    def __init__(self, rate: Optional[Any] = ..., log_rate: Optional[Any] = ..., validate_args: bool = ..., allow_nan_stats: bool = ..., name: str = ...) -> None: ...
    @property
    def rate(self): ...
    @property
    def log_rate(self): ...

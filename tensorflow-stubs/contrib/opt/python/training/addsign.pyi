# Stubs for tensorflow.contrib.opt.python.training.addsign (Python 3)
#
...
class AddSignOptimizer(optimizer.Optimizer):
    def __init__(self, learning_rate: float = ..., alpha: float = ..., beta: float = ..., sign_decay_fn: Optional[Any] = ..., use_locking: bool = ..., name: str = ...) -> None: ...

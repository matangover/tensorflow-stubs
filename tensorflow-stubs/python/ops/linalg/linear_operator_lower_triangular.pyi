# Stubs for tensorflow.python.ops.linalg.linear_operator_lower_triangular (Python 3)
#
...
class LinearOperatorLowerTriangular(linear_operator.LinearOperator):
    def __init__(self, tril: Any, is_non_singular: Optional[Any] = ..., is_self_adjoint: Optional[Any] = ..., is_positive_definite: Optional[Any] = ..., is_square: Optional[Any] = ..., name: str = ...) -> None: ...

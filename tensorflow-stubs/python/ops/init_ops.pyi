# Stubs for tensorflow.python.ops.init_ops (Python 3)
#
...
from tensorflow.python.util.deprecation import deprecated as deprecated, deprecated_arg_values as deprecated_arg_values
from tensorflow.python.util.tf_export import tf_export as tf_export
from typing import Any as Any, Optional as Optional

class Initializer:
    def __call__(self, shape: Any, dtype: Optional[Any] = ..., partition_info: Optional[Any] = ...) -> None: ...
    def get_config(self): ...
    @classmethod
...
class Zeros(Initializer):
    ...
    def __call__(self, shape: Any, dtype: Optional[Any] = ..., partition_info: Optional[Any] = ...): ...
    def get_config(self): ...
...
class Constant(Initializer):
    value: Any = ...
    dtype: Any = ...
    def __init__(self, value: int = ..., dtype: Any = ..., verify_shape: bool = ...) -> None: ...
    def __call__(self, shape: Any, dtype: Optional[Any] = ..., partition_info: Optional[Any] = ..., verify_shape: Optional[Any] = ...): ...
    def get_config(self): ...
...
class RandomUniform(Initializer):
    ...
    seed: Any = ...
    dtype: Any = ...
    def __init__(self, minval: int = ..., maxval: Optional[Any] = ..., seed: Optional[Any] = ..., dtype: Any = ...) -> None: ...
    def __call__(self, shape: Any, dtype: Optional[Any] = ..., partition_info: Optional[Any] = ...): ...
    def get_config(self): ...
...
class UniformUnitScaling(Initializer):
    ...
    seed: Any = ...
    dtype: Any = ...
    def __init__(self, factor: float = ..., seed: Optional[Any] = ..., dtype: Any = ...) -> None: ...
    def __call__(self, shape: Any, dtype: Optional[Any] = ..., partition_info: Optional[Any] = ...): ...
    def get_config(self): ...
...
class VarianceScaling(Initializer):
    ...
    seed: Any = ...
    dtype: Any = ...
    def __init__(self, scale: float = ..., mode: str = ..., distribution: str = ..., seed: Optional[Any] = ..., dtype: Any = ...) -> None: ...
    def __call__(self, shape: Any, dtype: Optional[Any] = ..., partition_info: Optional[Any] = ...): ...
    def get_config(self): ...
...
class Orthogonal(Initializer):
    ...
    dtype: Any = ...
    seed: Any = ...
    def __init__(self, gain: float = ..., seed: Optional[Any] = ..., dtype: Any = ...) -> None: ...
    def __call__(self, shape: Any, dtype: Optional[Any] = ..., partition_info: Optional[Any] = ...): ...
    def get_config(self): ...
...
class Identity(Initializer):
    gain: Any = ...
    dtype: Any = ...
    def __init__(self, gain: float = ..., dtype: Any = ...) -> None: ...
    def __call__(self, shape: Any, dtype: Optional[Any] = ..., partition_info: Optional[Any] = ...): ...
    def get_config(self): ...

class GlorotUniform(VarianceScaling):
    def __init__(self, seed: Optional[Any] = ..., dtype: Any = ...) -> None: ...
    def get_config(self): ...
